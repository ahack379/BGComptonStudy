...
void cosmics(){
	...
	TH2D * h = new TH2D("h","Vertices of Comptons/PP in Detector, Parent Out",50,0,256.35,50,-116.5,116.5) ;
	TCanvas * c = new TCanvas("c","c");
	t->Draw("_Y:_X>>h","(_PDG==3 || _PDG ==4) && _inActiveVolume && _parentInActiveVolume","COLZ");
    ...
    t->Draw("_E>>h1","_PDG==3 && _inActiveVolume && _parentInActiveVolume") ;
	c1->SetLogy() ;
    ...
    t->Draw("_E>>h2","_PDG==4 && _inActiveVolume && _parentInActiveVolume") ;
	c2->SetLogy() ;
    ...
    t->Draw("_distBackAlongTraj>>h3","_PDG ==3 && _inActiveVolume && _parentInActiveVolume") ;
    t->Draw("_distBackAlongTraj","_PDG ==3 && E > 0.05 && _inActiveVolume && _parentInActiveVolume") ;
	c3->SetLogy() ;
    ...
    t->Draw("_distBackAlongTraj>>h4","_PDG ==4 && _inActiveVolume && _parentInActiveVolume") ;
    t->Draw("_distBackAlongTraj","_PDG ==4 && E > 0.05  && _inActiveVolume && _parentInActiveVolume") ;
	c4->SetLogy() ;
    ...
    t->Draw("_X>>h5","_PDG == 3 && _inActiveVolume && _parentInActiveVolume") ;
    t->Draw("_X","_PDG == 3 && _E > 0.005 && _inActiveVolume && _parentInActiveVolume") ;
	h5->GetXaxis()->SetTitle("Distance (cm)");
	h5->SetLineColor(kRed);

	TH1D * h6 = new TH1D("h6","Compton Vertex (Y), Parent Out",150,-116.5,116.5) ;
	TCanvas * c6 = new TCanvas("c6","c6") ;	
    t->Draw("_Y>>h6","_PDG == 3 && _inActiveVolume && _parentInActiveVolume") ;
    t->Draw("_Y","_PDG == 3 && _E > 0.005 && _inActiveVolume && _parentInActiveVolume") ;
	h6->GetXaxis()->SetTitle("Distance (cm)");
	h6->SetLineColor(kRed);

	TH1D * h7 = new TH1D("h7","Compton Vertex (Z), Parent Out",150,0,1036.8) ;
	TCanvas * c7 = new TCanvas("c7","c7") ;	
  t->Draw("_Z>>h7","_PDG == 3 && _inActiveVolume && _parentInActiveVolume") ;
	t->Draw("_Z","_PDG == 3 && _E > 0.005 && _inActiveVolume && _parentInActiveVolume") ;
    ...
    t->Draw("_X>>h8","_PDG == 4 && _inActiveVolume && _parentInActiveVolume") ;
    t->Draw("_X","_PDG == 4 && _E > 0.05 && _inActiveVolume && _parentInActiveVolume") ;
	h8->GetXaxis()->SetTitle("Distance (cm)");
	h8->SetLineColor(kRed);

	TH1D * h9 = new TH1D("h9","PP Vertex (Y), Parent Out",30,-116.5,116.5) ;
	TCanvas * c9 = new TCanvas("c9","c9") ;	
    t->Draw("_Y>>h9","_PDG == 4 && _inActiveVolume && _parentInActiveVolume") ;
    t->Draw("_Y","_PDG == 4 && _E > 0.05 && _inActiveVolume && _parentInActiveVolume") ;
	h9->GetXaxis()->SetTitle("Distance (cm)");
	h9->SetLineColor(kRed);

	TH1D * h10 = new TH1D("h10","PP Vertex (Z), Parent Out",30,0,1036.8) ;
	TCanvas * c10 = new TCanvas("c10","c10") ;	
	t->Draw("_Z>>h10","_PDG == 4 && _inActiveVolume && _parentInActiveVolume") ;
	t->Draw("_Z","_PDG == 4 && _E > 0.05 && _inActiveVolume && _parentInActiveVolume") ;
